...
.. list-table::
   ...
   * - sriov-network-operator.images.operator
     - string
     - `"nvcr.io/nvstaging/mellanox/sriov-network-operator:network-operator-24.7.0-rc.1"`
     -
   ...
   * - sriov-network-operator.images.sriovConfigDaemon
     - string
     - `"nvcr.io/nvstaging/mellanox/sriov-network-operator-config-daemon:network-operator-24.7.0-rc.1"`
     -
   ...
   * - sriov-network-operator.images.webhook
     - string
     - `"nvcr.io/nvstaging/mellanox/sriov-network-operator-webhook:network-operator-24.7.0-rc.1"`
     -
